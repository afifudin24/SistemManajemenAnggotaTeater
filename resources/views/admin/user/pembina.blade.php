        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="contohModalLabel">Tambah Pembina</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="contohModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Header -->
                <div class="modal-header">
                    <h5 class="modal-title" id="contohModalLabel">Edit Pembina</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <form id="editForm" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="nama" id="nama_edit"
                                placeholder="Nama Pembina" required>
                            <label for="nama_edit" class="form-label">Nama Pembina</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="nip" id="nip_edit"
                                placeholder="NIP Pembina" required>
                            <label for="nip_edit" class="form-label">NIP Pembina</label>
                        </div>
                        <div class="form-floating mb-3">
    ...
    @push('scripts')
        <script>
            ...
            $('.btnEdit').click(function() {
                ...
                $('#editForm').attr('action', `/updatepembina/${user.id_pembina}`);
            })

            $('.btnHapus').click(function() {
                let user = $(this).data('user');
                console.log(user)
                $('#formHapus').attr('action', `/hapuspembina/${user.id_pembina}`);
            });
        </script>
    @endpush
