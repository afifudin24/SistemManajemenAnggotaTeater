...
<div class="content-wrapper">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- Bulan Filter --}}
                    <form method="GET" action="/adminrekapabsen/{{$id_pembina}}" id="form-filter" class="d-flex align-items-end  flex-wrap">
    <div>
    ...
    <div>
        ...
        <a href="{{ route('adminkehadiran.rekap.pdf', ['bulan' => $selectedBulan, 'id_pembina' => $id_pembina]) }}" target="_blank" class="btn btn-danger">
