                                ...
                                <tbody>
                                    @forelse ($punishment as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->tanggal }}</td>
                                            <td>
                                            @if($item->karya == null && $item->status_punishment == "Perlu Upload Karya")
                                                <button data-item="{{ $item }}" data-bs-toggle="modal" data-bs-target="#karyaModal" id="uploadKaryaBtn" class="btn btn-info">Upload Karya</button>
                                            @elseif($item->karya != null && $item->status_punishment == "Menunggu Konfirmasi")
                                            <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#lihatKaryaModal" data-item="{{ $item }}" id="lihatKaryaBtn">Lihat Karya</button>
                                            {{-- @else --}}
                                            @endif
                                            </td>
